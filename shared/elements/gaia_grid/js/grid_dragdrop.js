...
(function(exports) {
  ...
  DragDrop.prototype = {
    ...
    begin: function(e) {
      ...
      // Bug XXX In Marionette, pageX/pageY are undefined for contextmenu
      // events, but they should be the center of the element.
      if ((!pageX && pageX !== 0) || (!pageY && pageY !== 0)) {
        pageX = this.icon.x + this.icon.element.clientWidth / 2;
        pageY = this.icon.y + this.icon.element.clientHeight / 2;
      }
